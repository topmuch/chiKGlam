...
function HomePage() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 text-center">
          ...
          <FadeIn delay={0.45}>
            <Button
              size="lg"
              onClick={() => handleScrollTo('#engagements')}
      ...
      {/* ──── NOS ENGAGEMENTS ──── */}
      <section id="engagements" className="py-16 sm:py-20 md:py-28">
  ...
  return (
    <>
      ...
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#1a1a1a] via-[#2a2018] to-[#3a2a1a]" />
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_50%_50%,_#bc8752_0%,_transparent_60%)]" />
        <div className="relative z-10 px-4 text-center">
          <FadeIn>
            <p className="mb-3 text-xs tracking-[0.35em] text-[#bc8752] sm:text-sm">
              QUI SOMMES-NOUS
            </p>
          </FadeIn>
          <FadeIn delay={0.15}>
            <h1 className="text-4xl font-extrabold leading-tight tracking-wider text-white sm:text-5xl md:text-6xl">
              À PROPOS DE
              <br />
              <span className="text-[#bc8752]">CHIC &amp; GLAMOUR</span>
            </h1>
          </FadeIn>
          <FadeIn delay={0.3}>
            <p className="mx-auto mt-5 max-w-lg text-sm leading-relaxed text-white/60">
              Notre histoire, nos valeurs, notre passion
            </p>
          </FadeIn>
        </div>
        <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-white to-transparent" />
      ...
      <section className="py-16 sm:py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <SectionTitle title="NOTRE MARQUE" subtitle="Notre histoire en images" />
          </FadeIn>
      ...
      <section className="bg-[#faf8f5] py-16 sm:py-20 md:py-28">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <SectionTitle title="NOTRE MISSION" subtitle="Ce qui nous anime" />
          </FadeIn>
