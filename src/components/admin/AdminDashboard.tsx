          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {/* Glamshop Template */}
                <div
                  onClick={() => setSettingsForm({ ...settingsForm, activeTemplate: 'glamshop' })}
                  className={`relative cursor-pointer rounded-xl border-2 p-6 transition-all hover:shadow-md ${
                    settingsForm.activeTemplate === 'glamshop'
                      ? 'border-[#bc8752] bg-[#bc8752]/5 shadow-md'
                      : 'border-border hover:border-[#bc8752]/50'
                  }`}
                >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#bc8752' }}>
                        <Palette className="h-5 w-5 text-white" />
                      </div>
                      <div>
                        <h3 className="font-bold text-lg">Glamshop</h3>
                        <p className="text-xs text-muted-foreground">Template glamour doré</p>
                      </div>
                    </div>
                    <div className="flex gap-1.5">
                      <div className="w-6 h-6 rounded-full border border-neutral-300" style={{ backgroundColor: '#bc8752' }} />
                      <div className="w-6 h-6 rounded-full bg-white border border-neutral-300" />
                      <div className="w-6 h-6 rounded-full border border-neutral-300" style={{ backgroundColor: '#a07040' }} />
                    </div>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      Template cloné avec bandeau défilant, footer doré et design élégant
                    </p>
                  </div>
                </div>
              </div>
