...
export function NewArrivals() {
  const { data: liveProducts, isLoading, isError, isFetching, refetch } = useNewArrivals();
  const fallbackProducts = getNewArrivals();
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isLoading && !liveProducts ? (
          <div className="flex items-center justify-center py-16">
            ...
            <span className="ml-3 text-sm text-muted-foreground">Chargement des nouveautés...</span>
          </div>
        ) : (
