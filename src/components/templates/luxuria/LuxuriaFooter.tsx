...
// ─── Component ──────────────────────────────────────────────────
export default function LuxuriaFooter() {
  ...
  return (
    <footer className="mt-auto">
      {/* ================================================================
          ...
          ================================================================ */}
      <section style={{ backgroundColor: C.tertiary }}>
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20">
          <div className="text-center max-w-2xl mx-auto mb-8">
            ...
            <p className="text-sm sm:text-base leading-relaxed" style={{ color: C.textLight }}>
          ...
          >
            ...
            <Button
              type="submit"
              className="h-11 px-8 rounded-lg text-sm font-semibold text-white transition-all duration-200 hover:opacity-90"
          ...
          {subscribed && (
            <p className="text-center text-sm font-medium mb-8" style={{ color: C.primary }}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {trustBadges.map((badge) => (
              <div key={badge.label} className="flex flex-col items-center text-center group">
                ...
                >
                  <badge.icon className="size-5" style={{ color: C.primary }} />
                </div>
      ...
      {/* ================================================================
          2. MAIN FOOTER
          ================================================================ */}
      <section className="text-white" style={{ backgroundColor: C.darkBg }}>
                ...
                {socialLinks.map((social) => (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.backgroundColor = `${C.primary}20`;
                ...
                <div className="flex items-center gap-2">
                  {socialLinks.map((social) => (
                    <a
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.backgroundColor = `${C.primary}30`;
                        e.currentTarget.style.color = C.primaryLight;
                      }}
                      onMouseLeave={(e) => {
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 text-center sm:text-left">
              ...
              <div className="hidden sm:block w-px h-3" style={{ backgroundColor: 'rgba(255,255,255,0.1)' }} />
