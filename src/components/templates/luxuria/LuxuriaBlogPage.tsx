...
// ─── Component ───────────────────────────────────────────
export function LuxuriaBlogPage() {
      ...
      <section style={{ backgroundColor: C.sectionBg }}>
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-16 sm:py-20 lg:py-24">
          ...
          >
            ...
            <p className="text-base sm:text-lg leading-relaxed max-w-lg mx-auto" style={{ color: C.textLight }}>
...
export default LuxuriaBlogPage;
