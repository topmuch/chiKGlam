...
export function GoldenCartPage() {
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center px-4">
        ...
        >
          ...
          <h1
            className="font-heading text-3xl sm:text-4xl font-bold mb-3 tracking-wide"
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8 lg:gap-12">
          ...
          <div>
            ...
            >
              <h3
                className="font-heading text-lg font-semibold mb-6 uppercase tracking-wide"
                style={{ color: C.primary }}
              >
